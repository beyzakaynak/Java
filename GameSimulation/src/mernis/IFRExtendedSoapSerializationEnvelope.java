...
public class IFRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IFRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IFRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IFRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IFRDateTimeConverter dateTimeConverter = new IFRStandardDateTimeConverter();

    public IFRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IFRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IFRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IFRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IFRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IFRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
