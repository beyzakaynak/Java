...
public class IFRKPSPublicSoap
{
    ...
    public IFRKPSPublicSoap(){}

    public IFRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IFRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IFRExtendedSoapSerializationEnvelope envelope= new IFRExtendedSoapSerializationEnvelope(IFRExtendedSoapSerializationEnvelope.VER11);
